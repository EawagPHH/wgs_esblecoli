...
FigureS2 = ggplot(heatmap_long %>% filter(Presence == 1), aes(x = Gene, y = Sample)) +
...
# Create plot
FigureS3 <- ggplot(args_region, aes(x = Source, y = args, fill = Source)) +
...
# Save as PDF in A4 portrait format
ggsave("figures/ExtendedDataFig3.pdf", plot = FigureS5, width = 11.69, height = 8.27, units = "in")
```
